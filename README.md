...
joking aside, MySQL is making PHP more powerful and easy to use in PHP. You are using your store together with PHP code and MySQL data together in 1 server(GoDaddy). Easy to find source about that also have amazing communication if you need answer about your error :)
